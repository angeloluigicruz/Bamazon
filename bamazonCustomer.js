    ...
    inquirer.prompt([
        {
            name: "itemID",
            type: "input",
            message: "Please enter ID Number for Item you wish to buy: "
        },
        {
            name: "quantity",
            type: "input",
            message: "Please enter the quantity of items you wish to buy: "
        }
        ...
        connection.query("SELECT item_id, product_name, stock_quantity, price FROM products WHERE ?", { item_id: answer.itemID }, function(err, results) {
            ...
            if (results[0].stock_quantity >= answer.quantity) {
                ...
                console.log("Quantity requested exceeds available inventory in stock.");
                continueShopping();
            }
        })
    })
...
function continueShopping () {
    inquirer.prompt([
        ...
        if (answer.tryAgain) {
            ...
            console.log("Your session has ended.  Thank you for shopping at Bapple");
        }
    })
}
